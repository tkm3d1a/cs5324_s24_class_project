...
\title{CS Department Automated Information Timeline \\ Assignment 9.2: Component Diagram}
\date{\today}
...
\subsection{Purpose}
The purpose of this assignment is to collaborate as a team and create a component diagram of our project.

\section{Component Diagram}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=.98\textwidth]{images/ComponentDiagram.png}
%     \centering
